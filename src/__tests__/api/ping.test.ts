...
describe('/api/ping', () => {
  ...
  describe('Response consistency', () => {
    ...
    it('should return different timestamps on multiple calls', async () => {
      ...
      // Первый вызов
      jest.spyOn(Date.prototype, 'toISOString').mockReturnValueOnce('2023-01-01T00:00:00.000Z');
      await GET();
      
      // Второй вызов с другим временем
      jest.spyOn(Date.prototype, 'toISOString').mockReturnValueOnce('2023-01-01T00:01:00.000Z');
      await GET();
